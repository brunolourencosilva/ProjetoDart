//  4. Multiplicação de Elementos Ímpares com função
...
Map<String, List<int>> filtroImparPar(List<int> lista) {
  List<int> listaPar = [];
  List<int> listaImpar = [];
...
void main() {
  ...
  var resultado = filtroImparPar(listaInteiros);
  ...
  print('Lista de números ímpares multiplicados:');
