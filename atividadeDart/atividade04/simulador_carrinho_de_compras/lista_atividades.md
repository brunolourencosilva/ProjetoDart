...
O segundo projeto consiste na criação de um simulador de carrinho de compras, voltado à prática da manipulação de listas e mapas em conjunto. O sistema deve utilizar uma lista de mapas (List<Map<String, dynamic>>) para representar os produtos adicionados ao carrinho, sendo que cada produto deve conter as chaves ‘nome’, ‘preco’ e ‘quantidade’.
